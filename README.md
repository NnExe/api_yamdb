...
Денис занимался разработкой [категорий](#categories), [жанров](#genres) и [произведений](#titles). Андрей был тимлидом команды и занимался разработкой [отзывов](#reviews) и [комментариями](#comments). Николай занимался [авторизацией](#auth), [пользователями](#users) и [скриптом загрузки данных](#загрузка-данных)
